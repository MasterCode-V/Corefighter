...
class OpenAIClient:
    ...
    async def analyze_images(
        ...
        instruction = (
            "Extract product information. Use null when unknown. Respond as JSON with keys: "
            "manufacturer, product_name, model_number, category, condition, "
            "characteristics (array of short strings), and "
            "products (array). Each products item has: manufacturer, product_name, "
            "model_number, category, condition, quantity (integer), quantity_unit "
